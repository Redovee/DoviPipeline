Shader "Hidden/DoviGI/Lighting"
{
  ...
  HLSLINCLUDE
    ...
    #include "Assets/DoviRenderPipeline/ShaderLibrary/GI/BlitSupport.hlsl"
    #include "Assets/DoviRenderPipeline/ShaderLibrary/Radiances/Pixel.cginc"
