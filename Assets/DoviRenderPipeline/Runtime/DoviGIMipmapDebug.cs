...
[RequireComponent(typeof(DoviGI))]
[AddComponentMenu("Rendering/DoviGI Mipmap Debug")]
public class DoviGIMipmapDebug : MonoBehaviour
{
    [Range(1f, 9f)]
    ...
    void Awake()
    {
        ...
        _gi = GetComponent<DoviGI>();
    }

    void OnEnable()
    {
        _command = new CommandBuffer { name = "DoviGI.Debug.Mipmap" };
