...
[AddComponentMenu("Rendering/DoviGI")]
public class DoviGI : MonoBehaviour
{
    /// <summary>
    /// 公共变量
    /// </summary>
    ...
    {
        DoviRenderPipeline.TriggerCameraCallback(Camera, "OnPreRender", Camera.onPreRender);
        ...
        DoviRenderPipeline.TriggerCameraCallback(Camera, "OnPreCull", Camera.onPreCull);
        ...
        renderContext.ExecuteCommandBuffer(_command);
        _command.Clear();
        DoviRenderPipeline.TriggerCameraCallback(Camera, "OnPostRender", Camera.onPostRender);
    ...
    void OnEnable()
    {
        ...
        _command = new CommandBuffer { name = "DoviGI.MonoBehaviour" };
